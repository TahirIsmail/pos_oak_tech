...
class PurchaseOrder extends Model
{
    ...
    protected $fillable = ['slack', 'store_id', 'po_number', 'purchase_order_pdf', 'po_reference', 'order_date', 'order_due_date', 'supplier_id', 'supplier_code', 'supplier_name', 'supplier_address', 'po_from_id' , 'po_from_code', 'po_from_name', 'po_from_address', 'po_from_customer', 'currency_name', 'currency_code', 'tax_option_id', 'subtotal_excluding_tax', 'total_discount_amount', 'total_after_discount', 'total_tax_amount', 'shipping_charge', 'packing_charge', 'total_order_amount', 'terms', 'update_stock', 'status', 'tax_option', 'created_by', 'updated_by', 'created_at', 'updated_at'];
