...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'total_sale_price_including_tax' => $this->total_sale_price_including_tax,
            'category' => $this->category,
            'subcategory' => $this->subcategory,
            'child_category_id' => $this->child_category_id,
            // 'category_company' => $this->category_company,
            // 'product_name' => $this->product_name,
            'product_specifications' => $this->product_specifications->map(function ($specification) {
                return [
                    'id' => $specification->id,  // or other attributes of the product_specifications
                    'specification_label' => $specification->specification_label,
                    'specification_details' => $specification->specification_details,
                    'category_specification_details' => $specification->category_specification_details,
                ];
            }),
            ...
            "sale_price_percentage" => $this->sale_price_percentage,
            "total_sale_price_including_tax" => $this->total_sale_price_including_tax,
            "gst_on_product" => $this->gst_on_product,
