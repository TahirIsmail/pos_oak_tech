        ...
        if(count($active_stores)>0){
            ...
            foreach ($active_stores as $active_store) {
                ...
                for($j=0; $j<$count; $j++){
                    ...
                    $waiter_user = UserModel::select('slack')->where('email', 'waiter1@OAK.com')->first();
