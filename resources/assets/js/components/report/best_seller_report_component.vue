        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header  d-flex flex-wrap mb-4">
                    ...
                    <div class="">
                        <date-picker type="month" :lang='date.lang' :format="date.format" v-model="month"
                            @change="month_change" input-class="form-control bg-white"></date-picker>
                    </div>
                </div>
                ...
                <div class="d-flex flex-wrap">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 p-0">
                        <div class="">
                            <p class="para">List of top 10 products that sold most</p>
