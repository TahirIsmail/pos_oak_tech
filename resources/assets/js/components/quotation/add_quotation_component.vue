                ...
                <form @submit.prevent="submit_form" class="mb-3">
                    ...
                    <div class="form-row mb-2">
                        <div class="form-group col-md-4">
                            ...
                            <select name="bill_to" v-model="bill_to" v-validate="'required'"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <cool-select type="text" name="bill_to_slack" v-validate="'required'"
                                :placeholder="$t('Please choose Customer or Supplier')" autocomplete="off"
                                v-model="bill_to_slack" :items="bill_to_list" item-text="label" itemValue='slack'
                                @search='load_bill_to_list' ref="bill_to_label">
                            </cool-select>
                            <span v-bind:class="{ 'error': errors.has('bill_to_slack') }">{{ errors.first('bill_to_slack')
                            }}</span>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="quotation_reference">{{ $t("Quotation Reference #") }}</label>
                            <input type="text" name="quotation_reference" v-model="quotation_reference"
                                v-validate="'max:30'" class="form-control form-control-custom"
                                :placeholder="$t('Please enter quotation Reference #')" autocomplete="off">
                            <span v-bind:class="{ 'error': errors.has('quotation_reference') }">{{
                                errors.first('quotation_reference') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-row mb-2">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <date-picker :format="date.format" :lang='date.lang' v-model="quotation_date"
                                v-validate="'date_format:yyyy-MM-dd'"
                                input-class="form-control form-control-custom bg-white" ref="quotation_date"
                                name="quotation_date" :placeholder="$t('Please enter quotation Date')"
                                autocomplete="off"></date-picker>
                            <span v-bind:class="{ 'error': errors.has('quotation_date') }">{{
                                errors.first('quotation_date') }}</span>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="quotation_due_date">{{ $t("Quotation Due Date") }}</label>
                            <date-picker :format="date.format" :lang='date.lang' v-model="quotation_due_date"
                                :disabled-date="not_before_order_date" name="quotation_due_date"
                                v-validate="'date_format:yyyy-MM-dd'"
                                input-class="form-control form-control-custom bg-white"
                                :placeholder="$t('Please enter quotation Due Date')" autocomplete="off"></date-picker>
                            <span v-bind:class="{ 'error': errors.has('quotation_due_date') }">{{
                                errors.first('quotation_due_date') }}</span>
                        </div>
                        <div class="form-group col-md-4">
