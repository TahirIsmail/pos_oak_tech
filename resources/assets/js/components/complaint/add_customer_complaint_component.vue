    ...
    <div>
        <form @submit.prevent="submit_form">
            <div class="d-flex flex-wrap mb-4">
                <div class="mr-auto">
                    <span class="text-title" v-if="complaints_data == null">{{
                ...
                <div class="">
                    <button v-if="complaints_data == null" type="submit" class="btn btn-primary"
            ...
            <div class="form-row mb-2">
                ...
                <div class="form-group col-sm-12 col-md-4">
                    ...
                    <select v-model="selectedCustomer" @change="fetchCustomerOrders" v-validate="'required'"
                        class="form-control form-control-custom" placeholder="Choose Customers..">
                        <option value="" disabled>Choose Customers..</option>
                        <option v-for="(customer_item, index) in customer_list" v-bind:value="customer_item.slack"
                ...
                <div class="form-group col-sm-12 col-md-4">
                    <label for="order">{{ $t("Choose Order") }}</label>
                    <select v-model="selectedOrder" class="form-control form-control-custom" v-validate="'required'" @change="fetchOrderProducts">
                        <option value="" disabled>Select an Order..</option>
                        <option v-for="(order, index) in customerOrders" v-bind:value="order.slack" :key="index">
                ...
                <div class="form-group col-sm-12 col-md-4">
                    <label for="order">{{ $t("Choose Product") }}</label>
                    <select v-model="product_id" class="form-control form-control-custom" v-validate="'required'" @change="fetchOrderProducts">
                        <option value="" disabled>Select an Order..</option>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            show_modal: false,
            error_class: "",
            selectedCustomer: this.complaints_data && this.complaints_data.customer == null ? '' :this.complaints_data.customer.slack,
            selectedOrder: this.complaints_data && this.complaints_data.order == null ? '' :this.complaints_data.order.slack,
            product_id:this.complaints_data && this.complaints_data.product_id == null ? '' :this.complaints_data.product_id,
            customerOrders: [],
            orderProducts: [],

            api_link: this.complaints_data == null ? "/api/submit_customer_complaint" : "/api/update_customer_complaint/" + this.complaints_data.slack,
            complaint_slack: this.complaints_data && this.complaints_data.slack !== null ? this.complaints_data.slack : null,
            complaint_ref: this.complaints_data && this.complaints_data.complaint_ref !== null ? this.complaints_data.complaint_ref : null,
            complaint_status: this.complaints_data && this.complaints_data.complaint_status !== null ? this.complaints_data.complaint_status : null,
            description: this.complaints_data && this.complaints_data.description !== null ? this.complaints_data.description : null,
