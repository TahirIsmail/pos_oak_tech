      ...
      <div class="form-row mb-2">
        <div class="form-group col-sm-12 col-md-4">
          ...
          <div class="rating">
            <span
              v-for="star in max"
              v-bind:key="star"
              @click="delivery_timeline(star)"
            >
              {{ star <= DeliveryTimeline ? "★" : "☆" }}
            </span>
          </div>
          <textarea
            name="delivery_timeline"
            v-model="TDeliveryTimeline"
            v-validate="'required'"
            class="form-control form-control-custom"
            rows="5"
            :placeholder="$t('Delivery Timeline Feedback')"
          ></textarea>
        ...
        <div class="form-group col-sm-12 col-md-4">
          ...
          <textarea
            ...
            v-model="TProductQuality"
            v-validate="'required|max:65535'"
            class="form-control form-control-custom"
            rows="5"
            :placeholder="$t('Product Quality Feedback')"
          ></textarea>
        ...
        <div class="form-group col-sm-12 col-md-4">
          ...
          <textarea
            name="responsiveness"
            v-model="TResponsiveness"
            v-validate="'required|max:65535'"
            class="form-control form-control-custom"
            rows="5"
            :placeholder="$t('Responsiveness Feedback')"
          ></textarea>
