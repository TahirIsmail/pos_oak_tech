        ...
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="card-header d-flex flex-wrap mb-4">
                    <div class="mr-auto">
                        <span class="text-title" v-if="user_slack == ''">{{ $t("Add OutSource Vendor") }}</span>
                        <span class="text-title" v-else>{{ $t("Edit User") }}</span>
                    </div>
                    <div class="">
                        <button type="submit" class="btn btn-primary"  v-bind:disabled="processing == true"> <i class='fa fa-circle-notch fa-spin'  v-if="processing == true"></i> {{ $t("Save OutSource Vendor") }}</button>
                    </div>
                </div>
