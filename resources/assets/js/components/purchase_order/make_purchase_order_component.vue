          ...
          <form @submit.prevent="submit_form" class="mb-3">
            <div class="card-header d-flex flex-wrap mb-4">
              <div class="mr-auto">
                <span
                  class="text-title"
                  v-if="purchase_order_slack == ''"
                  >{{ $t("Add Purchase Order") }}</span
                >
                <span
                  class="text-title"
                  v-else
                  >{{ $t("Edit Purchase Order") }}</span
                >
              </div>
              <div class="">
                <button
            ...
            <div class="form-row mb-2">
              <div class="form-group col-md-3">
                ...
                <cool-select
                  ...
                  :placeholder="$t('Please choose supplier')"
                  autocomplete="off"
                  v-model="supplier"
                  :items="supplier_list"
                  item-text="label"
                  itemValue="slack"
                  @search="load_suppliers"
                  ref="supplier"
                >
                </cool-select>
                <span
                  v-bind:class="{ 'error' : errors.has('supplier') }"
            ...
            <div class="form-row mb-2">
              <div class="form-group col-md-3">
                ...
                <input
                  ...
                  :placeholder="$t('Please enter PO Number')"
                  autocomplete="off"
                />
                <span
                  v-bind:class="{ 'error' : errors.has('po_number') }"
                  >{{ errors.first('po_number') }}</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                <input
                  ...
                  v-validate="'max:30'"
                  class="form-control form-control-custom"
                  :placeholder="$t('Please enter PO Reference #')"
                  autocomplete="off"
                />
                <span
                  v-bind:class="{ 'error' : errors.has('po_reference') }"
                  >{{ errors.first('po_reference') }}</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                <date-picker
                  ...
                  ref="order_date"
                  name="order_date"
                  :placeholder="$t('Please enter Order Date')"
                  autocomplete="off"
                ></date-picker>
                <span
                  v-bind:class="{ 'error' : errors.has('order_date') }"
                  >{{ errors.first('order_date') }}</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                <date-picker
                  ...
                  v-validate="'date_format:yyyy-MM-dd'"
                  input-class="form-control form-control-custom bg-white"
                  :placeholder="$t('Please enter Order Due Date')"
                  autocomplete="off"
                ></date-picker>
                <span
                  v-bind:class="{ 'error' : errors.has('order_due_date') }"
            ...
            <div class="form-row mb-2">
              <div class="form-group col-md-3">
                ...
                <span
                  v-bind:class="{ 'error' : errors.has('currency') }"
              ...
              <div class="form-group col-md-3">
                ...
                >
                  ...
                  <option
                    v-for="(tax_option, index) in tax_options"
                    v-bind:value="tax_option.tax_option_constant"
                    v-bind:key="index"
                  >
                    {{ tax_option.label }}
                  </option>
                ...
                <span
                  v-bind:class="{ 'error' : errors.has('tax_option') }"
                  >{{ errors.first('tax_option') }}</span
                >
              </div>
            </div>
            ...
            <div class="form-row mb-2">
              <div class="form-group col-md-3">
                <label for="purchase_order_pdf">{{
                $t("Purchase Order Document") + " (jpeg, jpg, png, webp, pdf)"
                }}</label>
                <input
                  type="file"
                  class="form-control-file form-control form-control-custom file-input"
                  name="purchase_order_pdf"
                  ref="purchase_order_pdf"
                  accept="image/x-png,image/jpeg,image/webp/pdf"
                  v-validate="'ext:jpg,jpeg,png,webp,pdf|size:1500'"
                
                />
                <small class="form-text text-muted mb-1"
                  >Allowed file size file is 1.5 MB</small
                >
              </div>
            </div>
            ...
            <div class="form-row mb-2">
              <div class="form-group col-md-6">
                ...
                <textarea
                  ...
                  class="form-control form-control-custom"
                  rows="5"
                  :placeholder="$t('Enter Terms')"
                ></textarea>
                <span
                  v-bind:class="{ 'error' : errors.has('terms') }"
            ...
            >
              ...
              <div class="form-group col-md-1">
                ...
                />
                <span
                  v-bind:class="{ 'error' : errors.has('product.quantity_'+index) }"
              ...
              <div class="form-group col-md-2">
                ...
                />
                <span
                  v-bind:class="{ 'error' : errors.has('product.unit_price_'+index) }"
              ...
              <div class="form-group col-md-1">
                ...
                />
                <span
                  v-bind:class="{ 'error' : errors.has('product.discount_percentage_'+index) }"
                  >{{ errors.first('product.discount_percentage_'+index) }}</span
                >
              </div>
              <div class="form-group col-md-1">
                <select
                  v-bind:name="'product.tax_type_'+index"
                  v-model="product.tax_type"
                  v-validate="''"
                  class="form-control form-control-custom custom-select"
                  v-on:change="calculate_price"
                  data-vv-as="Tax Type"
                >
                  <option
                    v-for="(tax_type, index) in tax_types"
                    v-bind:value="tax_type.tax_type_constant"
                    v-bind:key="index"
                  >
                    {{ tax_type.label }}
                  </option>
                ...
                <span
                  v-bind:class="{ 'error' : errors.has('product.tax_type_'+index) }"
              ...
              <div class="form-group col-md-1">
                ...
                />
                <span
                  v-bind:class="{ 'error' : errors.has('product.tax_percentage_'+index) }"
            ...
            <div class="form-row mb-3">
              ...
              <div class="col-md-2">
                ...
                />
                <span
                  v-bind:class="{ 'error' : errors.has('shipping_charge') }"
            ...
            <div class="form-row mb-3">
              ...
              <div class="col-md-2">
                ...
                />
                <span
                  v-bind:class="{ 'error' : errors.has('packing_charge') }"
  ...
  export default {
      ...
      data(){
          return{
              ...
              modal           : false,
              show_modal      : false,
              api_link        : '/api/add_purchase_order',
  
              supplier_list   : [],
              product_list   :this.quotation_data.products,
              quotation_from_supplier: this.quotation_data.quotation_from_supplier,
              search_product : '',
              ...
              created_by_customer: (this.is_customer) ? true : false,
              ...
              terms : (this.quotation_data == null)?'':(this.quotation_data.terms != null)?this.quotation_data.terms:'',
              ...
              po_product_list : this.quotation_data.products,
              ...
              this.$validator.validateAll().then((result) => {
                  if (result) {
                      ...
                      this.$on("submit",function () {
                          ...
                          for (var i = 0; i < this.$refs.purchase_order_pdf.files.length; i++) {
                            let file = this.$refs.purchase_order_pdf.files[i];
                            formData.append("purchase_order_pdf[" + i + "]", file);
                          }
                          ...
                          formData.append("created_by_customer", this.created_by_customer);
                          formData.append("quotation_from_supplier", this.quotation_from_supplier);
