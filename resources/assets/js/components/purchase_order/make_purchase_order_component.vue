            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2" v-for="(product, index) in products" :key="index">
                    ...
                    <div class="form-group col-md-1">
                        <input type="number" v-bind:name="'product.quantity_'+index" v-model="product.quantity" v-validate="'required|decimal|min_value:1'" data-vv-as="Quantity" class="form-control form-control-custom"  autocomplete="off" step="0.01" min="0" v-on:input="calculate_price" readonly>
