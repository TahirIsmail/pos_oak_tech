        ...
        <div class="col-md-12">
                ...
                <form @submit.prevent="submit_form" class="mb-3">
                    ...
                    <div class="form-row mb-2">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <cool-select type="text" v-model="search_user" autocomplete="off"
                                ...
                                @search='load_users' @select='add_user_to_list' :placeholder="$t('Choose users..')">
                                <template #item="{ item }">
                    ...
                    <div class="form-row mb-2">
                        <div class="d-flex flex-row flex-wrap p-1">
                            <div class="text-center mr-2 mb-2" v-for="(user, index) in users" v-bind:value="role.slack"
                                v-bind:key="index">
                                <div>
                                ...
                                <div class="ml-3 align-self-center">
                                    ...
                                    <button type="button" class="close ml-2 mt-1" aria-label="Close"
            ...
            <modalcomponent v-if="show_modal" v-on:close="show_modal = false">
                ...
                <template v-slot:modal-body>
                    <p class="display-block" v-show="role != '' && users.length == 0">Note : All the users with selected role
                        will be notified</p>
