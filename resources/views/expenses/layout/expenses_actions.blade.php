<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
        @if (check_access(array('A_DETAIL_EXPENSES'), true))
            <a href="view_expenses/{{ $row->slack }}" class="dropdown-item">{{ __("View") }}</a>
        @endif
        @if (check_access(array('A_EDIT_EXPENSES'), true))
            <a href="edit_expenses/{{ $row->slack }}" class="dropdown-item">{{ __("Edit") }}</a>
        @endif
    </div>
</div>