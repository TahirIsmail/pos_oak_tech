...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="my-4">
                <table id="product_request_table" class="table display nowrap w-100">
                    <thead>
                        <tr>
    
                            <th>{{ __("#") }}</th>
                            <th>{{ __("Product Request")}}</th>
                            <th>{{ __("User")}}</th>
                            <th>{{ __("Request Start Time") }}</th>
                            <th>{{ __("Request Complete") }}</th>
                            <th>{{ __("Action") }}</th>
                        </tr>
                    </thead>
                    <tbody>
